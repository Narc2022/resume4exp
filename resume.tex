...
\name{\LARGE Sachin}{\LARGE Singh}
% \position{Software Architect{\enskip\cdotp\enskip}Security Expert}

% \address{YOUR ADDRESS}
\mobile{+91 8983729702}
\email{sachinnarofficials@gmail.com}
%\dateofbirth{January 1st, 1970}
\homepage{cluster-front.vercel.app} 
\github{github.com/Narc2022}
\linkedin{linkedin.com/in/sachinsinghsde1}
% \gitlab{gitlab-id}
